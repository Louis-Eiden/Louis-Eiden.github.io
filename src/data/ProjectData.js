export const projectData = [
  ...
  },
  {
    ...
    text_en:
      "For the qrush project, I developed the entire web interface using modern frontend technologies. " +
      "Working with design elements created by Philipp Daub, I implemented a responsive and intuitive user interface that brings the vision of qrush to life. " +
      "The technical foundation of this project rests on Bun as the JavaScript runtime, with TypeScript providing type safety throughout the codebase. " +
      "I built the component architecture using React, which allowed for efficient development and maintenance. " +
      "My role focused exclusively on the frontend implementation, translating Philipp's design concepts into functional, interactive components while ensuring optimal performance and user experience. " +
      "This project demonstrates my ability to take design specifications and implement them with modern web technologies, creating seamless experiences through clean, maintainable code. ",
    text_de:
      'Bei diesem Projekt habe ich die komplette Frontend-Programmierung für die Webanwendung "QRush" übernommen. Meine Aufgabe umfasste die Umsetzung des von Philipp Daub konzipierten Designs ' +
      "in eine funktionale und responsive Benutzeroberfläche. " +
      "Für die technische Umsetzung nutzte ich einen modernen Stack aus Bun, TypeScript und React. In meinem Verantwortungsbereich lag die Implementierung sämtlicher UI-Komponenten sowie der gesamten Frontend-Logik. " +
      "Während des Projekts arbeitete ich eng mit dem Designer Philipp Daub zusammen, um seine Designvision optimal in Code umzusetzen. " +
      "Das Projekt demonstriert meine Fähigkeiten im Umgang mit aktuellen Frontend-Technologien sowie meine Expertise in der präzisen Umsetzung anspruchsvoller Designkonzepte in funktionalen Code.",
  },
  {
    Name: "Email",
  ...
  {
    Name: "Abbrandwächter",
    desktop_img: "/assets/projects/abbrandsensor/abbrandsensor-1.png",
    mobile_img: "/assets/projects/abbrandsensor/abbrandsensor-mobile-1.jpg",
    text_en:
      ...
      "The App connects automatically to the WiFi of the ESP (if present) to set the WiFi Credentials. " +
      ...
      "As soon as the Wifi Data is set and a connection is established the ESP disables his Wifi AP and connects directly to the Wifi. " +
      ...
      "The App displays the temperature and the status of the device. alternatively you can visit the <a href='https://abbrandwächter.local' class='link'>Webpage</a><span class='link-arrow'>&#129133;</span> of the device. " +
    ...
    text_de:
      ...
      "Die App verbindet sich automatisch mit dem WLAN des ESP (falls vorhanden), um die WLAN-Zugangsdaten einzurichten. " +
      ...
      "Die App zeigt die Temperatur und den Status des Geräts an. Alternativ können Sie auch die <a href='https://abbrandwächter.local' class='link'>Webseite</a><span class='link-arrow'>&#129133;</span> des Geräts besuchen. " +
